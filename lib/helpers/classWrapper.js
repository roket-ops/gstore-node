function wrap(schema, params, hooks = []) {
  ...
  staticProps.forEach(name => {
    ...
    console.log('this is the schame', schema.statics);
    console.log('this is the method.value', method.value);
    if (typeof method.value === 'function') schema.statics[name] = method.value;
  });
