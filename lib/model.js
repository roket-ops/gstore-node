    ...
    */
    ...
    class Model extends Entity{
        constructor (data, id, ancestors, namespace, key) {
            if (!namespace) namespace = process.env.NAMESPACE || 'default';
        ...
        static query(namespace, transaction) {
            ...
            query.runAsync = Promise.promisify(query.run);
    ...
    // const promisify = (object, name) => {
    //     // const orginalFn = object[name];
    //     object[name] = Promise.promisify(object[name]);
    // };
    // promisify(Model, 'get');
    // promisify(Model, 'update');
    // promisify(Model, 'list');
    // promisify(Model, 'delete');
    // promisify(Model, 'deleteAll');
    // promisify(Model, 'findOne');
    // promisify(Model, 'findAround');
    // promisify(Model.prototype, 'save');
    // promisify(Model.prototype, 'validate');
